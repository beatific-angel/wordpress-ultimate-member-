		...
		function edit_field( $key, $data, $rule = false, $args = array() ) {
			...
			switch ( $type ) {
				...
				case 'image':
                    ...
                    //over_text display part
                    $over_num =0;
                    $cover_index =$over_index;
                    switch ($cover_index){
                        case '0':
                            $index = um_user('over_text', $cover_index, $over_num);
                            $index1 = um_user('over_text', $cover_index, $over_num+1);
                            $index2 = um_user('over_text', $cover_index, $over_num+2);
                            $index3 = um_user('over_text', $cover_index, $over_num+3);
                            $url_index1 = um_user('over_url', $cover_index, $over_num+1);
                            $url_index2 = um_user('over_url', $cover_index, $over_num+2);
                            $url_index3 = um_user('over_url', $cover_index, $over_num+3);
                        case '1':
                            $index = um_user('over_text', $cover_index, $over_num);
                            $index1 = um_user('over_text', $cover_index, $over_num+1);
                            $index2 = um_user('over_text', $cover_index, $over_num+2);
					...
					$output .='	<div class="um-modal-left">
									    <input type="text" class="um-cover-text" placeholder="header name" style="width:100%;" value="'.$index.'">
									    <input type="text" class="um-cover-text1" placeholder="text/url_name" style="width:50%;float:left;" value="'.$index1.'">
									    <input type="text" class="um-cover-url1" placeholder="url address" style="width:50%;" value="'.$url_index1.'">
									    <input type="text" class="um-cover-text2" placeholder="text/url_name" style="width:50%;float:left;" value="'.$index2.'">
									    <input type="text" class="um-cover-url2" placeholder="url address" style="width:50%;" value="'.$url_index2.'">
									    <input type="text" class="um-cover-text3" placeholder="text/url_name" style="width:50%;float:left;" value="'.$index3.'">
									    <input type="text" class="um-cover-url3" placeholder="url address" style="width:50%;" value="'.$url_index3.'">
									</div>';
								}
					$output .='	<div class="um-modal-right">
										<a href="javascript:void(0);" class="um-modal-btn um-finish-upload image" data-key="' . $key . '" data-change="' . __( 'Change photo', 'ultimate-member' ) . '" data-processing="' . __( 'Processing...', 'ultimate-member' ) . '"> ' . __( 'Apply', 'ultimate-member' ) . '</a>
